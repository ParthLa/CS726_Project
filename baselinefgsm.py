...
print(model.classifier[6].weight.data.shape)
W = model.classifier[6].weight.data
edges = []
for i in range(1000):
  for j in range(4096):
...
#print(edges)
for n in range(int(0.1*1000*4096)):
  W[edges[n][1],edges[n][2]] = 0

model.classifier[6].weight.data = W
...
edges.sort(key = lambda x:x[0])
#print(edges)
for n in range(int(0.1*9216*4096)):
  W[edges[n][1],edges[n][2]] = 0

model.classifier[1].weight.data = W

W = model.classifier[4].weight.data
edges = []
for i in range(4096):
  for j in range(4096):
    edges.append([abs(W[i,j]),i,j])
...
edges.sort(key = lambda x:x[0])
#print(edges)
for n in range(int(0.1*4096*4096)):
  W[edges[n][1],edges[n][2]] = 0

model.classifier[4].weight.data = W
